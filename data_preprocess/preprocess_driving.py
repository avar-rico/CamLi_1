...
parser.add_argument('--input_dir', required=False, default=r'G:\CV-dataset\OpticalFlow\Driving', help='Path to the Driving dataset')
parser.add_argument('--output_dir', required=False, default=r'G:\CV-dataset\OpticalFlow\Driving_processed')
